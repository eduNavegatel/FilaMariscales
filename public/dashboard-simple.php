                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="/prueba-php/public/admin/productos" class="btn btn-primary me-2">Gestión de Productos</a>
                                <a href="/prueba-php/public/admin/nuevo-producto" class="btn btn-success me-2">Nuevo Producto</a>
                                <a href="/prueba-php/public/test-tienda-simple.php" class="btn btn-info">Test de Tienda</a>
                            </div>
                        </div>
                    </div>
                </div>
