        ...
        <div class="row">
            <div class="col-12">
                <h1 class="h3 mb-4 text-primary">
                    <i class="fas fa-tachometer-alt me-2"></i>Panel de Administración - Filá Mariscales
                </h1>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="card text-white bg-purple h-100 shadow">
                            <div class="card-body d-flex flex-column">
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    <div>
                                ...
                                <a href="/prueba-php/public/admin/cuotas" class="btn btn-light btn-sm mt-auto">
